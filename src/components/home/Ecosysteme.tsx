  ...
  return (
    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary/10">
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="2" y="12" width="4" height="8" rx="1.5" fill="#19120E" opacity="0.4" />
        <rect x="9" y="7" width="4" height="13" rx="1.5" fill="#19120E" opacity="0.7" />
        <rect x="16" y="2" width="4" height="18" rx="1.5" fill="#19120E" />
        <path d="M3 10 L10 5 L16 8" stroke="#CC2C05" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <circle cx="16" cy="8" r="2" fill="#CC2C05" />
      </svg>
    </div>
  );
}
...
function TransmiExpertIcon() {
  return (
    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-accent/10">
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="5" cy="11" r="3.5" stroke="#CC2C05" strokeWidth="1.5" />
        <circle cx="17" cy="11" r="3.5" fill="#CC2C05" />
        <path d="M8.5 9.5 L13.5 9.5" stroke="#CC2C05" strokeWidth="1.5" strokeLinecap="round" />
        <path d="M11.5 7.5 L13.5 9.5 L11.5 11.5" stroke="#CC2C05" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M8.5 12.5 L13.5 12.5" stroke="#CC2C05" strokeWidth="1.5" strokeLinecap="round" opacity="0.4" />
      </svg>
    </div>
  );
}
...
function SecureXiaIcon() {
  return (
    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-secondary">
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M11 2 L19 5.5 L19 11 C19 15.4 15.4 19.2 11 20 C6.6 19.2 3 15.4 3 11 L3 5.5 Z" stroke="#19120E" strokeWidth="1.5" strokeLinejoin="round" fill="#19120E" fillOpacity="0.06" />
        <path d="M7.5 11 L9.5 13 L14.5 8.5" stroke="#19120E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </div>
  );
}
...
function AdamBoardsMockup() {
  return (
    <div className="w-full overflow-hidden rounded-xl border border-primary/20 bg-[#F9F6F2]">
...
function SecureXiaMockup() {
  return (
    <div className="w-full overflow-hidden rounded-xl border border-border/40 bg-[#F9F6F2]">
