...
const STEPS = [
  ...
  },
  {
    ...
    illustration: (
      <svg width="120" height="100" viewBox="0 0 120 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="20" y="54" fontSize="10" fill="#FF5C35" textAnchor="middle" fontFamily="Figtree, sans-serif" fontWeight="700">A</text>
        <circle cx="60" cy="25" r="10" fill="rgba(92,78,255,0.15)" stroke="#5C4EFF" strokeWidth="1.5" />
        <text x="60" y="29" fontSize="9" fill="#5C4EFF" textAnchor="middle" fontFamily="Figtree, sans-serif" fontWeight="700">⚡</text>
        <circle cx="60" cy="75" r="10" fill="rgba(92,78,255,0.15)" stroke="#5C4EFF" strokeWidth="1.5" />
        <text x="60" y="79" fontSize="9" fill="#5C4EFF" textAnchor="middle" fontFamily="Figtree, sans-serif" fontWeight="700">📅</text>
        <circle cx="100" cy="50" r="10" fill="rgba(92,78,255,0.25)" stroke="#5C4EFF" strokeWidth="1.5" />
        <text x="100" y="54" fontSize="10" fill="#5C4EFF" textAnchor="middle" fontFamily="Figtree, sans-serif" fontWeight="700">B</text>
        {/* Connections */}
        ...
        {/* Pulse on B */}
        <circle cx="100" cy="50" r="16" stroke="#5C4EFF" strokeWidth="1" opacity="0.2" />
        <circle cx="100" cy="50" r="22" stroke="#5C4EFF" strokeWidth="0.5" opacity="0.1" />
        {/* Checkmark badge */}
  ...
  },
  {
    ...
    description:
      "Chaque mois, un rapport clair : leads traités, RDV pris, temps économisé, CA attribuable. Pas de tableau de bord inutilisé — juste les 3 chiffres qui comptent pour votre activité.",
    illustration: (
      <svg width="120" height="100" viewBox="0 0 120 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        {/* Dashboard card */}
        ...
        <polyline points="18,72 30,62 42,65 55,45 68,50 80,30 92,22 104,18 104,72" fill="rgba(92,78,255,0.07)" />
        {/* Data points */}
        ...
        <text x="92" y="42" fontSize="8" fill="#FF5C35" textAnchor="middle" fontFamily="Figtree, sans-serif" fontWeight="400" opacity="0.7">CE MOIS</text>
        <text x="92" y="52" fontSize="11" fill="#FF5C35" textAnchor="middle" fontFamily="Figtree, sans-serif" fontWeight="800">+47%</text>
        {/* Bottom axis */}
    ...
    <section ref={ref} className="bg-[#12122A] py-20 sm:py-28">
      <div className="container-page">
        ...
        <div className="relative mt-16 grid gap-0 md:grid-cols-3">
          ...
          <div aria-hidden className="absolute left-[calc(16.67%+1.5rem)] right-[calc(16.67%+1.5rem)] top-[3.25rem] hidden h-px bg-white/10 md:block" />
